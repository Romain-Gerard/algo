...
We give a bijection between type B set partitions without zero block over $\langle n \rangle$ and type B strongly separated set partitions whithout zero block over <n+1>.
